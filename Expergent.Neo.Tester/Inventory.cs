...
namespace CRMSample.Models
{
    ...
    public partial class Inventory
    {
        ...
        public override PropertyComparer SortOrder
        {
            get
            {
                return new PropertyComparer("ProductID", SortDirection.Ascending);
            }
        }
    ...
    /// </remarks>
    [Serializable]
    public class InventorySurrogate : InventorySurrogateBase
    {
        private StringBuilder _sb;

        /// <summary>Default constructor.</summary>
        public InventorySurrogate()
        {
        ...
        public InventorySurrogate(Inventory entity) : base(entity)
        {
            _sb = new StringBuilder();
        }
